...
#include "Utility.h"
enum EntityType { PLATFORM, PLAYER, KNIGHT, KEY };
enum AIType     { WALKER, FREEKey, AttackingKNIGHT, RunningKNIGHT, MovingPLATFORM };
...
public:
    ...
    bool check_collision_simple(Entity* other) const;
    ...
    void ai_key(float delta_time);
    void ai_knight_1();
    void ai_knight_2(float delta_time);
    void ai_platform(float delta_time);
